...
import type { GoogleCredentialResponse } from "@/types/google-oauth"
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex justify-between items-center">
                        ...
                        <Link
                          to="/forgot-password"
                          className="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline transition-colors"
                        >
                          Forgot password?
                        </Link>
                      </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  {/* Fallback Google Button (if OAuth doesn't load) */}
                  {!window.google && (
                    <Button 
                      type="button"
                      variant="outline" 
